<?php
 ...
 $query = "SELECT * FROM issues,users where  users.id = issues.userid  and users.clg = '$clg' and issues.status = 'unresolved' order by datei desc ";
...
<div class="row" id = "content">
	...
	<div class = "col-lg-10"	>
		<div class="card mb-3" >
<b style ="font-size : 25px;"> <?php echo $_SESSION['clg'] ;?> college greviences </b>
		<?php
		if(mysqli_num_rows($res) == 0)
		{
